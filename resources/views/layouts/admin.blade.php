  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item{{ request()->is('admin/tag*') ? ' active' : '' }}">
        ...
        <div id="tag" class="collapse{{ request()->is('admin/tag*') ? ' show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tag:</h6>
            <a class="collapse-item{{ request()->is('admin/tag') ? ' active' : '' }}{{ request()->is('admin/tag') ? ' active' : '' }}" href="{{ route('admin.tag.index') }}">Daftar Tag</a>
            <a class="collapse-item{{ request()->is('admin/tag/sampah*') ? ' active' : '' }}{{ request()->is('admin/tag/sampah') ? ' active' : '' }}" href="{{ route('admin.tag.trash') }}">Sampah</a>
          </div>
        </div>
      </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle mt-4" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="row">
                  ...
                  @isset($us->image)
                  <img class="img-profile rounded-circle" src="{{ asset('uploads/users/' . $us->image) }}" style="width: 40px; height: 40px;">
                  @endisset
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Your <a href="https://github.com/MuhammadIhsanAnsory">Muhammad Ihsan Ansory</a> 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLogout">Anda yakin logout?</h5>
